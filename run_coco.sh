...
IMAGENET_PRETRAIN=pre-trained/ImageNetPretrained/MSRA/R-101.pkl                            # <-- change it to you path
IMAGENET_PRETRAIN_TORCH=pre-trained/ImageNetPretrained/torchvision/resnet101-5d3b4d8f.pth  # <-- change it to you path
